                ...
                ))}
                {
                  isLoading && (
                    <div className="flex gap-4 max-w-3xl w-full py-3">
                      <Image className="h-9 w-9 p-1 bordeer border-white/15 rounded-full" src={assets.logo_icon} alt=""/>
                      <div className="loader flex justify-center items-center gap-1">
                        <div className="w-1 h-1 roundeed-full bg-white animate-bounce"></div>
                        <div className="w-1 h-1 roundeed-full bg-white animate-bounce"></div>
                        <div className="w-1 h-1 roundeed-full bg-white animate-bounce"></div>
                      </div>
                    </div>
